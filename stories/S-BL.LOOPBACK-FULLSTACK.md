...
(`.factory/decisions/S-BL.LOOPBACK-FULLSTACK-placement-note.md` v1.14) — **story-writer's job here is
...
(binding per placement note v1.14):** AC-013 verifies via the direct invocation the merged file's own doc
...
**Second forward obligation (placement note v1.14 Risks item 6):** this story's binding `RoundTrip`-token
