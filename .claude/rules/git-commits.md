...
All commits must be SSH-signed. Never use `--no-gpg-sign`, `--no-sign`,
or any flag that bypasses signature verification. If signing fails,
stop and investigate — do not work around it.
